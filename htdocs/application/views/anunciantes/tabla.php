                    ...
                    <ul>
                        <li>
                            ...
                            <?php if ($usuario != false && $usuario['idnivel'] <= Administrador): ?>
                                <a class="title float60" href="/anunciantes/<?php echo $anunciante['idanunciantes'] ?>"><?php echo $anunciante['nombre'] ?></a>
                                <ul class="floatright">
                                    <li class="floatleft">
                            ...
                            <?php else: ?>
                                <a class="title" href="/anunciantes/<?php echo $anunciante['idanunciantes'] ?>"><?php echo $anunciante['nombre'] ?></a>
                            <?php endif ?>    
