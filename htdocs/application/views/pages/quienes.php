...
<div class="contenido">
    <div class="float70">
        <p>"Somos una publicación mensual, de distribución gratuita, con una trayectoria periodística de más de 22 años en la zona norte.
        ...
        <ul>
            ...
            <li>Filomena Lorca</li>
            <li>José María Morán</li>
            <li>Anabela Tamagna</li>
            <li>Mirta Parrado</li>
            <li>Daniel Falcón</li>
            <li>Armando Marquez</li>
        </ul>
    </div>
    <div class="float30">
    </div>
